  ...
  return (
    <Container>
      ...
      <FormContainer>
        <FormWrapper>
          ...
          <Form onSubmit={handleSubmit}>
            ...
            <div style={{ marginBottom: "10px", display: "flex", gap: "10px" }}>
              ...
              <div>
                <label htmlFor="terms">
                  Sign up to JustJeans emails and receive 15% off your next full
                  price purchase at JustJeans.
                </label>
              </div>
            </div>
        ...
        <ImageWrapper>
          <img src="https://justjeans.jgl.com.au/JJ/aurora/images/espot/static/account/JJ24AW_CreateAccount.png?impolicy=scale" />
        </ImageWrapper>
      </FormContainer>
    </Container>
  );
